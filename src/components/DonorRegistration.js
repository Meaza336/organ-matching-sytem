    ...
    <div className="container">
      ...
      <div className="row flex-fill">
        ...
        <div className="col-md-9">
          <h3 className="my-4 text-center">Donor Registration Form</h3>
          <div className="bg-success text-white p-3 mb-4 text-center" >
          ...
          <div className="p-4 border rounded shadow">
            <form>
              ...
              <div className="mb-3">
                <label htmlFor="emergencyContact" className="form-label">Emergency Contact Information:</label>
                <input type="text" className="form-control" id="emergencyContact" placeholder="Name" required />
                <input type="text" className="form-control mt-2" id="relationship" placeholder="Relationship" required />
                <input type="tel" className="form-control mt-2" id="emergencyPhone" placeholder="Phone Number" required />
              </div>
              ...
              {/* Organ Type */}
              <div className="mb-3">
                <label htmlFor="organType" className="form-label">Organ To Donate:</label>
              ...
              {/* Chronic Illnesses */}
              <div className="mb-3">
                <label htmlFor="chronicIllnesses" className="form-label">Chronic Illnesses (e.g., diabetes, hypertension):</label>
                <textarea className="form-control" id="chronicIllnesses" rows="3"></textarea>
              </div>

              {/* Previous Surgeries */}
              <div className="mb-3">
                <label htmlFor="previousSurgeries" className="form-label">Previous Surgeries:</label>
                <textarea className="form-control" id="previousSurgeries" rows="3"></textarea>
              </div>

              {/* Current Medications */}
              <div className="mb-3">
                <label htmlFor="currentMedications" className="form-label">Current Medications:</label>
                <textarea className="form-control" id="currentMedications" rows="3"></textarea>
              </div>

              {/* Infectious Diseases */}
              <div className="mb-3">
                <label htmlFor="infectiousDiseases" className="form-label">Infectious Diseases (e.g., HIV, Hepatitis):</label>
                <textarea className="form-control" id="infectiousDiseases" rows="3"></textarea>
              </div>

              {/* Vaccination History */}
              <div className="mb-3">
                <label htmlFor="vaccinationHistory" className="form-label">Vaccination History:</label>
                <textarea className="form-control" id="vaccinationHistory" rows="3"></textarea>
              </div>

              {/* Lifestyle Factors */}
              <div className="mb-3">
                <label htmlFor="lifestyleFactors" className="form-label">Lifestyle Factors:</label>
                <textarea className="form-control" id="lifestyleFactors" rows="3"></textarea>
              </div>
